...
image = PhotoImage(file="Tree dog.png")
...
Label(tool_bar, text="Tools", relief=RAISED).grid(row=0, column=0, padx=5, pady=3, ipadx=100)  # ipadx is padding inside the Label widget
